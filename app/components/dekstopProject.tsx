export const caseStudies = [
  {
    ...
    description:
      "Embark on an unforgettable journey to Labuan Bajo with our Travel Website. Seamlessly order and schedule your trip with our user-friendly interface. Powered by Next.js, TypeScript, and Tailwind for a sleek frontend experience, and Postgresql - ExpressJs for a robust backend.",
  },
  {
